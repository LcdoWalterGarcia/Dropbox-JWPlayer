	...
	<div class="container">
		...
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
			...
			<div class="form-group">
			    <br>
				<label class="font-weight-bold">LINK Direct Dropbox:</label>
				<input type="text" name="link" class="form-control" placeholder="Ex: https://dl.dropboxusercontent.com/s/3v2exouhu2fz89k/1.mp4"this.select()" required>
			</div>
		...
		<label class="font-weight-bold">Example link Direct Dropbox: https://dl.dropboxusercontent.com/s/3v2exouhu2fz89k/1.mp4 </label>
		<label class="font-weight-bold">Example link Dropbox: https://www.dropbox.com/s/bkxm9k2titi35wc/3v2exouhu2fz89k/1.mp4 </label>
	</div><!-- /.container -->
	<?php
	}
